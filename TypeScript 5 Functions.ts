export default function (): void {
  ...
  {
    const buildName = function (firstName: string, lastName?: string): string {
      if (lastName) {
  ...
  {
    const buildName = function (firstName: string, lastName: string = 'Smith') {
      return firstName + ' ' + lastName
    }
    ...
    const result5 = buildName('Bob', 'Adams')         // ah, just right
